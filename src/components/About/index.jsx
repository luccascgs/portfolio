import { Section, Column1, Column2, Quote } from "./styles";

export default function About() {
    return (
        <Section>
            <Column1>
                <img alt="Foto de Perfil" src="https://www.infoescola.com/wp-content/uploads/2008/05/capivara-119654188.jpg" />
            </Column1>
            <Column2>
                <h1>SOBRE MIM</h1>
                <p>Olá, sou o <b>Luccas Gomes</b>. 👋🏻</p>
                <p>Trabalho com edição de vídeos profissionais para diversas plataformas, como YouTube, TikTok e Instagram. Também possuo experiência com edição de chamadas televisivas e clipes musicais.</p>
                <p>Desde novo, sempre fui apaixonado pelo audiovisual, cinema, e efeitos especiais. Hoje, trago esta mesma paixão e experiência para os meus projetos.</p>
                <Quote>
                    <span>"</span>
                    <p>
                ...
                <div className="contacts">
                    ...
                    <a href="mailto:luccascorreia.24@gmail.com" target="_blank" rel="noreferrer">
                    ...
                    <a href="tel:+5511954917244" target="_blank" rel="noreferrer">
